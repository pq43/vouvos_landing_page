            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="mt-0 mb-8">Fast to setup, easy to use</h4>
                  <p className="m-0 text-sm">
                    Call others right away with Project Vouvos when you make an
                    account. To call others, simply send them a chat invite or
                    enter their username to get started immediately.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  ...
                  <p className="m-0 text-sm">
                    Regardless of whether you use iOS or Android, our app will
                    be available for you to download for free.
                  </p>
                </div>
              </div>
            </div>
